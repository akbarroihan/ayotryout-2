                                    ...
                                    <?php
                                        ...
                                        foreach ($data['data_riwayat'] as $riwayat) : ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button"  class="btn btn-outline btn-info" data-toggle="modal" data-target="#modalDetailRiwayat" data-id="<?= $riwayat['id_user']; ?>=<?= $riwayat['token']; ?>">Detail</button>
                                                </td>
                                            </tr>
                                        <?php
                                        endforeach;
